...
function choosingwinner(uscho,cmpcho){
    ...
    if(uscho === "rock"){
        if(cmpcho === "rock"){
              compCHOICE.src = "/Rock paper scissors/assets/fist.png";
              resulttext.innerText = "Its a Draw!!";
        }else if(cmpcho === "scissors"){
             compCHOICE.src = "/Rock paper scissors/assets/peace.png";
             resulttext.innerText = "Congratulations! You won!!";
        }
        else{
             compCHOICE.src = "/Rock paper scissors/assets/hand-palm.png";
...
choicerock.addEventListener("click", () =>{
    ...
    userCHOICE.src = "/Rock paper scissors/assets/fist.png";
...
choicepaper.addEventListener("click", () =>{
    userchoice = "paper";
    cmpchoice = compchoices[compchoice];
    userCHOICE.src = "/Rock paper scissors/assets/hand-palm.png";
...
choicescissors.addEventListener("click", () =>{
    userchoice = "scissors";
    cmpchoice = compchoices[compchoice];
    userCHOICE.src = "/Rock paper scissors/assets/peace.png";
